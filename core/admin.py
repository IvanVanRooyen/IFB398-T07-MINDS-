...
class UserProfileAdmin(djadmin.ModelAdmin):
    ...
    fieldsets = (
        ("User Information", {"fields": ("user", "organisation", "role", "clearance_level")}),
        ("Contact Details", {"fields": ("department", "phone", "employee_id")}),
        ("Approval Permissions", {"fields": ("can_approve_jorc", "can_approve_valmin")}),
...
class ApprovalWorkflowAdmin(djadmin.ModelAdmin):
    ...
    fieldsets = (
        ("Workflow Details", {"fields": ("workflow_type", "status", "content_type", "object_id")}),
