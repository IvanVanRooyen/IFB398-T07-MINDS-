...
from .models import AuditLog, UserProfile, log_audit
        ...
        def wrapper(request, *args, **kwargs):
            ...
            if user_role not in allowed_roles:
                raise PermissionDenied(
                    f"Role {user_role} not authorized for this action"
                )
    ...
    def decorator(view_func):
        ...
        def wrapper(request, *args, **kwargs):
            ...
            user_level = clearance_hierarchy.get(
                request.user.profile.clearance_level, 0
            )
                ...
                try:
                    ...
                    if model_class.__name__ == "Document":
                        ...
                        DocumentView.objects.create(
                            user=request.user, document=obj, ip_address=ip_address
                        )
