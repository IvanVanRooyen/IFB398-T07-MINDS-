...
def home(request):
    if request.htmx:
        return render(request, 'partial/home_content.html')
    
    return render(request, 'core/home.html')

def profile(request):
    if request.htmx:
        return render(request, 'partial/profile_content.html')
...
#         request,
#         "core/upload.html",
#         {"form": form, "docs": Document.objects.order_by("-created_at")[:20]},
#     )
